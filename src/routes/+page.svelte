        ...
        <div class="container relative z-10 mx-auto px-6 pt-20">
            <div class="max-w-3xl">
                ...
                <div class="flex flex-col sm:flex-row gap-5">
                    ...
                    <a href="https://wa.me/{CONTACTS.whatsapp}" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center gap-3 px-10 py-5 bg-emerald-600/10 backdrop-blur-md border border-emerald-500/30 text-emerald-400 font-bold rounded-2xl hover:bg-emerald-600 hover:text-white transition-all duration-500 text-lg shadow-[0_0_15px_rgba(16,185,129,0.1)]">
